...
*/
#define JucePlugin_Name                     "dRowAudio_Echo"

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "An Echo Plugin"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'Echo'
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           dRowAudio_Echo

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "dRowAudio_Echo"
...
*/
#define JucePlugin_CFBundleIdentifier       "dRowAudio.Echo"
