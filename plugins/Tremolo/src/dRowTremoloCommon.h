...
public:
	...
	public:
		...
		#define TremoloInterfaceParameterNames { "Gain", "Rate", "Depth", "Shape", "Phase" }
		enum {
			Gain = 0,
			Rate,
			Depth,
...
//	public:
//		static char* Names[];
//		#define TremoloInterfaceMeterNames { "Out L", "Out R" }
//		enum {
//			OutL = 0,
//			OutR,
//			Count
...
//	public:
//		static char* Names[];
//		#define TremoloInterfaceButtonNames { "Swap", "Centre", "Left", "Right" }
//		enum {
//			Swap = 0,
//			Centre,
//			Left,
...
//		static char* Label;
//		static char* Names[];
//		#define TremoloInterfaceMenuOptionsLabel "Pan Law"
//		#define TremoloInterfaceMenuOptionNames { "-6dB linear pan", "-3dB constant power pan" }
//		enum {
