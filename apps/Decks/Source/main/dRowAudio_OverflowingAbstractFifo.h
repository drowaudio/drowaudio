...
/**
    ...
    private:
        OverflowingAbstractFifo abstractFifo;
        int myBuffer [1024];
    };
    @endcode
*/
class OverflowingAbstractFifo
{
public:
    //==============================================================================
    /** Creates a FIFO to manage a buffer with the specified capacity. */
    OverflowingAbstractFifo (int capacity) throw();

    /** Destructor */
    ~OverflowingAbstractFifo();
...
//	void prepareToWriteOverflowing (int numToWrite, int& startIndex1, int& blockSize1, int& startIndex2, int& blockSize2) const throw();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (OverflowingAbstractFifo);
};
