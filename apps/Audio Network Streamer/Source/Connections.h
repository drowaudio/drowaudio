/*
  ==============================================================================
    ...
    Connections.h
    Created: 20 May 2011 6:24:30am
    Author:  David Rowland

  ==============================================================================
*/

#ifndef __CONNECTIONS_H_4B14583A__
#define __CONNECTIONS_H_4B14583A__

#include <dRowAudio/dRowAudio.h>

class AudioInterprocessConnection;
...
public:
	...
	OwnedArray <AudioInterprocessConnection, CriticalSection> activeConnections;
...
//==============================================================================
class AudioInterprocessConnection  : public InterprocessConnection
{
	
public:
	
	AudioInterprocessConnection (NetworkAudio &owner_)
...
//		DBG("client connectionLost");
	...
	{
//		DBG("client messageRecieved");
		owner.messageReceived(message);
	}
...
//==============================================================================
class AudioInterprocessConnectionServer   : public InterprocessConnectionServer
{
	
public:
	AudioInterprocessConnectionServer (NetworkAudio &owner_)
	:	owner (owner_)
	{
	}
	
	~AudioInterprocessConnectionServer()
	{
	}
	
	AudioInterprocessConnection* createConnectionObject()
	{
		AudioInterprocessConnection* newConnection = new AudioInterprocessConnection (owner);
...
#endif  // __CONNECTIONS_H_4B14583A__
