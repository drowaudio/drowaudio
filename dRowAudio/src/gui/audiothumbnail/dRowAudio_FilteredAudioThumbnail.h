...
#ifndef __DROWAUDIO_FILTEREDAUDIOTHUMBNAIL_JUCEHEADER__
#define __DROWAUDIO_FILTEREDAUDIOTHUMBNAIL_JUCEHEADER__
...
/**
	...
	This filtered version also takes a BiquadFilterSetup wich will be applied to
	the thumbnail generated. Take a look at TribandDraggableWaveDisplay for an
	example of its use.
 
    @see AudioThumbnailCache
*/
class FilteredAudioThumbnail    : public ChangeBroadcaster
{
public:
    //==============================================================================
    ...
    */
    FilteredAudioThumbnail (int sourceSamplesPerThumbnailSample,
							AudioFormatManager& formatManagerToUse,
							MultipleAudioThumbnailCache& cacheToUse,
							BiquadFilterSetup filterSetupToUse);

    /** Destructor. */
    ~FilteredAudioThumbnail();
...
private:
    //==============================================================================
    AudioFormatManager& formatManagerToUse;
    MultipleAudioThumbnailCache& cache;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (FilteredAudioThumbnail);
};


#endif   // __DROWAUDIO_FILTEREDAUDIOTHUMBNAIL_JUCEHEADER__
