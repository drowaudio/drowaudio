...
*/
#define JucePlugin_Name                     "Base Metered Plugin"						// needs changing
...
*/
#define JucePlugin_Manufacturer             "David Rowland"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'BMtr'								// needs changing
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           PluginBaseEffect

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "PluginBaseEffect"
...
*/
#define JucePlugin_CFBundleIdentifier       "com.dRowAudio.Plugin"
