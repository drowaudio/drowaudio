...
*/
#define JucePlugin_Name                     "Practical5"						// needs changing

/** A longer decription of your plugin.
*/
#define JucePlugin_Desc                     "A Gate Plugin"
...
/** A unique four-character code for your plugin.
    ...
    upper-case letter.
*/
#define JucePlugin_PluginCode               'Prc5'								// needs changing
...
/** A prefix for the names of exported entry-point functions that the component exposes.
    ...
    _abcViewEntry
*/
#define JucePlugin_AUExportPrefix           GatePlugin

/** This is the same as JucePlugin_AUExportPrefix, but in quotes
    (needed for the resource compiler...)
*/
#define JucePlugin_AUExportPrefixQuoted     "GatePlugin"
